...
<body>
    ...
    <![endif]-->
	<section class="fxt-template-animation fxt-template-layout3" data-bg-image="<?php echo base_url('') ?>assets/login/img/figure/best-resources-to-learn-front-end-development.png.webp">
		<button class="btn btn-sm btn-primary autoLogin" id="autoLogin"></button>
